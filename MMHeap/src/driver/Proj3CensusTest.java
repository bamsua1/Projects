/* File: Proj3CensusTest.java

   Use data from 2010 US Census to test quartile heaps.
*/
...
public class Proj3CensusTest {
   ...
   public static void main (String [] args) {
      ...
      q = new QHeap<CensusCity>(new CensusCity(false), 2000) ;

      System.out.println("\n\n==== Using 2010 Census Data  ===") ;

      // Insert stats for cities in California

      for(int i = 0 ; i < CA_2010.length ; i++) {
         
         temp = new CensusCity(CA_city[i], CA_state[i], CA_2010[i], CA_2011[i]) ;
         q.insert(temp) ;
      }


      System.out.println("\n*** Report on cities in California with population >50,000") ;
      result = q.getMin() ;
      System.out.println("   The smallest city in California is: " + result) ;
      result = q.get25() ;
      System.out.println("   The 25th percentile city in California is: " + result) ;
      result = q.get50() ;
      System.out.println("   The median city in California is: " + result) ;
      result = q.get75() ;
      System.out.println("   The 75th percentile city in California is: " + result) ;
      result = q.getMax() ;
      System.out.println("   The largest city in California is: " + result) ;
      
      // q.dump() ;

      // Insert stats for other states in the US

      for(int i = 0 ; i < OS_2010.length ; i++) {
         
         temp = new CensusCity(OS_city[i], OS_state[i], OS_2010[i], OS_2011[i]) ;
         q.insert(temp) ;
      }

      System.out.println("\n*** Report on cities in the U.S. with population >50,000") ;
      result = q.getMin() ;
      System.out.println("   The smallest city in the U.S. is: " + result) ;
      result = q.get25() ;
      System.out.println("   The 25th percentile city in the U.S. is: " + result) ;
      result = q.get50() ;
      System.out.println("   The median city in the U.S. is: " + result) ;
      result = q.get75() ;
      System.out.println("   The 75th percentile city in the U.S. is: " + result) ;
      result = q.getMax() ;
      System.out.println("   The largest city in California is: " + result) ;
      ...
      QHeap<CensusCity> q2 = new QHeap<CensusCity>(new CensusCity(true), 2000) ;

      System.out.println("\n\n==== Using 2011 Estimated Population ===") ;
